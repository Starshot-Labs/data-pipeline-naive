"""Compose downloaded InternScenes bundles with the authors' own composer.
    ...
    python pipeline/compose_internscenes.py data/internscenes/<export-id>
    python pipeline/compose_internscenes.py data/internscenes/<export-id> scannet/scene0000_00

The composition code is the untouched upstream file vendored at
pipeline/internscenes/compose_scenes.py (InternRobotics/InternScenes, commit a3614c24). This
